...
(function(vendor_qrcode) {
  ...
  function drawModuleRoundedDark(ctx, l, t, r, b2, rad, nw, ne, se, sw) {
    if (nw) {
      ctx.moveTo(l + rad, t);
    } else {
      ctx.moveTo(l, t);
    }
    function lal(b3, x0, y0, x1, y1, r0, r1) {
      if (b3) {
    ...
    lal(ne, r, t, r, b2, -rad, 0);
    lal(se, r, b2, l, b2, 0, -rad);
    lal(sw, l, b2, l, t, rad, 0);
    lal(nw, l, t, r, t, 0, rad);
  }
  function drawModuleRoundendLight(ctx, l, t, r, b2, rad, nw, ne, se, sw) {
    ...
    if (se) mlla(r, b2, -rad, -rad);
    if (sw) mlla(l, b2, rad, -rad);
  }
...
var CsQrCode = class extends CornerstoneElement {
  constructor() {
    super(...arguments);
    this.value = "";
    this.label = "";
...
CsQrCode.css = qr_code_styles_default;
__decorateClass([
  e("canvas")
], CsQrCode.prototype, "canvas", 2);
__decorateClass([
  n()
], CsQrCode.prototype, "value", 2);
__decorateClass([
  n()
], CsQrCode.prototype, "label", 2);
__decorateClass([
  n({ type: Number })
], CsQrCode.prototype, "size", 2);
__decorateClass([
  n()
], CsQrCode.prototype, "fill", 2);
__decorateClass([
  n()
], CsQrCode.prototype, "background", 2);
__decorateClass([
  n({ type: Number })
], CsQrCode.prototype, "radius", 2);
__decorateClass([
  n({ attribute: "error-correction" })
], CsQrCode.prototype, "errorCorrection", 2);
__decorateClass([
  n()
], CsQrCode.prototype, "image", 2);
__decorateClass([
  n({ attribute: "image-background" })
], CsQrCode.prototype, "imageBackground", 2);
__decorateClass([
  n({ attribute: "image-coverage", type: Number })
], CsQrCode.prototype, "imageCoverage", 2);
__decorateClass([
  n({ attribute: "image-padding", type: Number })
], CsQrCode.prototype, "imagePadding", 2);
CsQrCode = __decorateClass([
