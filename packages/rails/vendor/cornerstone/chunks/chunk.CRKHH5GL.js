...
var y = class extends HTMLElement {
  ...
  static createProperty(t2, s3 = b) {
    if (s3.state && (s3.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t2) && ((s3 = Object.create(s3)).wrapped = true), this.elementProperties.set(t2, s3), !s3.noAccessor) {
      const i4 = /* @__PURE__ */ Symbol(), h2 = this.getPropertyDescriptor(t2, i4, s3);
  ...
  _$AK(t2, s3) {
    ...
    if (void 0 !== e3 && this._$Em !== e3) {
      ...
      this._$Em = e3;
      const r3 = h2.fromAttribute(s3, t3.type);
      this[e3] = r3 ?? this._$Ej?.get(e3) ?? r3, this._$Em = null;
    }
  }
  requestUpdate(t2, s3, i4, e3 = false, h2) {
    if (void 0 !== t2) {
      const r3 = this.constructor;
      if (false === e3 && (h2 = this[t2]), i4 ?? (i4 = r3.getPropertyOptions(t2)), !((i4.hasChanged ?? f)(h2, s3) || i4.useDefault && i4.reflect && h2 === this._$Ej?.get(t2) && !this.hasAttribute(r3._$Eu(t2, i4)))) return;
      this.C(t2, s3, i4);
    }
...
(s2.litElementVersions ?? (s2.litElementVersions = [])).push("4.2.2");
