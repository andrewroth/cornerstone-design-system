...
import {
  ...
  wireToTimeSegments,
  withSecondsForStep
} from "./chunk.UN7CJLC5.js";
import {
  time_input_styles_default
} from "./chunk.NROFKOE5.js";
import {
  CsShowEvent
...
var uniqueId = 0;
var generateId = () => `cs-time-input-${++uniqueId}`;
var SINGLE_GROUP = "single";
var CsTimeInput = class extends CornerstoneFormAssociatedElement {
  constructor() {
    super(...arguments);
  ...
  columnItemsFor(field) {
    ...
    if (field === "hour") {
      ...
      if (this.resolvedHour12) {
        for (let h = 1; h <= 12; h++) {
          items2.push({ label: String(h).padStart(2, "0"), value: h, disabled: false });
        }
      } else {
        for (let h = 0; h <= 23; h++) {
          items2.push({ label: String(h).padStart(2, "0"), value: h, disabled: false });
    ...
    return b`
          ...
          >
            ...
            >
              ...
              <div
                ...
                aria-label=${hasLabel ? A : groupAriaLabel}
              >
      ...
      "Use arrow keys to change values; press Alt+Down Arrow to open the time picker."
              ...
              <input
                ...
                step=${o(this.step === "any" ? "any" : String(this.step))}
                ?disabled=${this.disabled}
                ?required=${this.required}
                autocomplete=${o(this.autocomplete || void 0)}
              />

              ${this.withClear && hasValue ? b`<button
                      part="clear-button"
                      type="button"
                      class="clear-button"
            ...
            >
              ...
              ${hasFooterSlot ? b`<div class="popup-footer"><slot name="footer"></slot></div>` : this.withNow ? b`<div class="popup-footer">
  ...
  renderSegmentGroup(layout) {
    ...
    for (const token of layout.tokens) {
      if (token.kind === "literal") {
        nodes.push(b`<span part="segment-literal" class="segment-literal" aria-hidden="true">${token.text}</span>`);
      } else {
  ...
  renderSegment(field, isTabStop) {
    ...
    return b`<span
      ...
      aria-valuenow=${o(value == null ? void 0 : value)}
  ...
  renderColumn(field) {
    ...
    return b`<div
      ...
      aria-activedescendant=${o(activedescendantId)}
...
CsTimeInput.css = [size_styles_default, form_control_styles_default, segmented_field_styles_default, time_input_styles_default];
CsTimeInput.shadowRootOptions = {
  ...CornerstoneFormAssociatedElement.shadowRootOptions,
  delegatesFocus: true
};
__decorateClass([
  e(".time-input-popup")
], CsTimeInput.prototype, "popup", 2);
__decorateClass([
  e(".value-input")
], CsTimeInput.prototype, "valueInput", 2);
__decorateClass([
  r()
], CsTimeInput.prototype, "segments", 2);
__decorateClass([
  n({ reflect: true })
], CsTimeInput.prototype, "name", 2);
__decorateClass([
  r()
], CsTimeInput.prototype, "value", 1);
__decorateClass([
  n({ attribute: "value", reflect: true })
], CsTimeInput.prototype, "defaultValue", 2);
__decorateClass([
  n({ type: Boolean })
], CsTimeInput.prototype, "disabled", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], CsTimeInput.prototype, "required", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], CsTimeInput.prototype, "readonly", 2);
__decorateClass([
  n({ reflect: true })
], CsTimeInput.prototype, "size", 2);
__decorateClass([
  n({ reflect: true })
], CsTimeInput.prototype, "appearance", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], CsTimeInput.prototype, "pill", 2);
__decorateClass([
  n()
], CsTimeInput.prototype, "label", 2);
__decorateClass([
  n({ attribute: "hint" })
], CsTimeInput.prototype, "hint", 2);
__decorateClass([
  n()
], CsTimeInput.prototype, "autocomplete", 2);
__decorateClass([
  n({ attribute: "with-clear", type: Boolean })
], CsTimeInput.prototype, "withClear", 2);
__decorateClass([
  n({ attribute: "with-now", type: Boolean })
], CsTimeInput.prototype, "withNow", 2);
__decorateClass([
  n({ attribute: "ssr-label", type: Boolean })
], CsTimeInput.prototype, "ssrLabel", 2);
__decorateClass([
  n({ attribute: "ssr-hint", type: Boolean })
], CsTimeInput.prototype, "ssrHint", 2);
__decorateClass([
  n({ attribute: "ssr-footer", type: Boolean })
], CsTimeInput.prototype, "ssrFooter", 2);
__decorateClass([
  n({ reflect: true })
], CsTimeInput.prototype, "min", 2);
__decorateClass([
  n({ reflect: true })
], CsTimeInput.prototype, "max", 2);
__decorateClass([
  n({ converter: { fromAttribute: stepFromAttribute, toAttribute: stepToAttribute } })
], CsTimeInput.prototype, "step", 2);
__decorateClass([
  n({ attribute: "hour-format", reflect: true })
], CsTimeInput.prototype, "hourFormat", 2);
__decorateClass([
  n({ type: Boolean, reflect: true })
], CsTimeInput.prototype, "open", 2);
__decorateClass([
  n({ reflect: true })
], CsTimeInput.prototype, "placement", 2);
__decorateClass([
  n({ type: Number, reflect: true })
], CsTimeInput.prototype, "distance", 2);
__decorateClass([
  watch("disabled", { waitUntilFirstUpdate: true })
], CsTimeInput.prototype, "handleDisabledChange", 1);
__decorateClass([
  watch("open", { waitUntilFirstUpdate: true })
], CsTimeInput.prototype, "handleOpenChange", 1);
CsTimeInput = __decorateClass([
