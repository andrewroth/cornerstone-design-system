...
var translation = {
  ...
  jumpBackwardX: (count) => {
    if (count === 1) {
      return "P\u0159ej\xEDt o 1 str\xE1nku zp\u011Bt";
    }
    if (count >= 2 && count <= 4) {
      return `P\u0159ej\xEDt o ${count} str\xE1nky zp\u011Bt`;
    }
    return `P\u0159ej\xEDt o ${count} str\xE1nek zp\u011Bt`;
  },
  jumpForwardX: (count) => {
    if (count === 1) {
      return "P\u0159ej\xEDt o 1 str\xE1nku vp\u0159ed";
    }
    if (count >= 2 && count <= 4) {
      return `P\u0159ej\xEDt o ${count} str\xE1nky vp\u0159ed`;
    }
  ...
  numCharactersRemaining: (num) => {
    if (num === 1) {
      return "1 zb\xFDvaj\xEDc\xED znak";
    }
    if (num >= 2 && num <= 4) {
      return `${num} zb\xFDvaj\xEDc\xED znaky`;
    }
  ...
  numRowsCopied: (num) => {
    if (num === 1) {
      return "Byl zkop\xEDrov\xE1n 1 \u0159\xE1dek";
    }
    if (num >= 2 && num <= 4) {
      return `Byly zkop\xEDrov\xE1ny ${num} \u0159\xE1dky`;
    }
    return `Bylo zkop\xEDrov\xE1no ${num} \u0159\xE1dk\u016F`;
  },
  numRowsSelected: (num) => {
    if (num === 1) {
      return "Je vybr\xE1n 1 \u0159\xE1dek";
    }
    if (num >= 2 && num <= 4) {
      return `Jsou vybr\xE1ny ${num} \u0159\xE1dky`;
    }
  ...
  rangeTooLong: (max) => {
    if (max === 1) {
      return "Vyberte rozsah nejv\xFD\u0161e 1 den";
    }
    if (max >= 2 && max <= 4) {
      return `Vyberte rozsah nejv\xFD\u0161e ${max} dny`;
    }
    return `Vyberte rozsah nejv\xFD\u0161e ${max} dn\u016F`;
  },
  rangeTooShort: (min) => {
    if (min === 1) {
      return "Vyberte rozsah dlouh\xFD alespo\u0148 1 den";
    }
    if (min >= 2 && min <= 4) {
      return `Vyberte rozsah dlouh\xFD alespo\u0148 ${min} dny`;
    }
