...
var translation = {
  ...
  jumpBackwardX: (count) => {
    if (count === 1) {
      return "Retroceder 1 p\xE1gina";
    }
    return `Retroceder ${count} p\xE1ginas`;
  },
  jumpForwardX: (count) => {
    if (count === 1) {
      return "Avanzar 1 p\xE1gina";
    }
  ...
  numCharacters: (num) => {
    if (num === 1) {
      return "1 car\xE1cter";
    }
    return `${num} caracteres`;
  },
  numCharactersRemaining: (num) => {
    if (num === 1) {
      return "1 car\xE1cter restante";
    }
  ...
  rangeTooLong: (max) => {
    if (max === 1) {
      return "Seleccione un intervalo no mayor de 1 d\xEDa";
    }
    return `Seleccione un intervalo no mayor de ${max} d\xEDas`;
  },
  rangeTooShort: (min) => {
    if (min === 1) {
      return "Seleccione un intervalo de al menos 1 d\xEDa";
    }
